...
func (_Token *TokenCaller) TotalSupply1(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function _totalSupply() view returns(uint256)
func (_Token *TokenSession) TotalSupply1() (*big.Int, error) {
	return _Token.Contract.TotalSupply1(&_Token.CallOpts)
}

// TotalSupply1 is a free data retrieval call binding the contract method 0x3eaaf86b.
//
// Solidity: function _totalSupply() view returns(uint256)
func (_Token *TokenCallerSession) TotalSupply1() (*big.Int, error) {
	return _Token.Contract.TotalSupply1(&_Token.CallOpts)
}
